 ...
 * 在本例中，我们手动设置了区块链、对等组等。您还可以使用WalletAppKit，它提供了restoreWalletFromSeed函数来从确定性种子加载钱包。
 */
public class RestoreFromSeed {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String seedCode = "addict hazard crowd alpha rib tape cousin panel tourist second uniform dolphin";
        String passphrase = "";
        Long creationtime = 1565681795L;
