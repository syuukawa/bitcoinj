...
//        OptionSpec<NetworkEnum> net = parser.accepts("net", "The network to run the examples on").
//                withRequiredArg().ofType(NetworkEnum.class).defaultsTo(NetworkEnum.REGTEST);
...
//        }
    ...
    public void run(NetworkParameters params) throws Exception {
        ...
        // TODO
        final int timeoutSeconds = params.getId().equals(NetworkParameters.ID_REGTEST) ? 150 : 1500;
