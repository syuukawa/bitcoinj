...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WalletAppKit kit = new WalletAppKit(params, new File("."), "regtest-send-002");
        kit.startAsync();
        kit.awaitRunning();
        ...
        Coin value = Coin.parseCoin("0.05");

        // To which address you want to send the coins?
        // The Address class represents a Bitcoin address.
        LegacyAddress to = LegacyAddress.fromBase58(params, "mr9ysTXxAXbTi6SQZCmULP8437jDCbnWgP");
